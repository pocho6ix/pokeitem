...
export const CARD_RARITY_ORDER: Record<CardRarity, number> = {
  ...
  [CardRarity.ULTRA_RARE]: 5,
  [CardRarity.ILLUSTRATION_RARE]: 6,
  [CardRarity.SPECIAL_ILLUSTRATION_RARE]: 7,
  [CardRarity.NOIR_BLANC_RARE]: 8,
  [CardRarity.HYPER_RARE]: 9,
  [CardRarity.MEGA_HYPER_RARE]: 10,
  [CardRarity.MEGA_ATTAQUE_RARE]: 11,
  [CardRarity.ACE_SPEC_RARE]: 12,
  [CardRarity.PROMO]: 13,
};
