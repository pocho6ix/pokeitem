...
const SERIES_DATA = [
  ...
  { blocSlug: "ex", name: "Team Rocket Returns", abbreviation: "EX07", slug: "team-rocket-returns", releaseDate: new Date("2004-11-08"), order: 9 },
  ...
  { blocSlug: "wotc", name: "Skyridge", abbreviation: "WOTC-SK", slug: "skyridge", releaseDate: new Date("2003-12-17"), order: 1 },
  { blocSlug: "wotc", name: "Expédition", abbreviation: "WOTC-EX", slug: "expedition", releaseDate: new Date("2002-09-15"), order: 2 },
  { blocSlug: "wotc", name: "Gym Challenge", abbreviation: "WOTC-GC", slug: "gym-challenge", releaseDate: new Date("2000-10-16"), order: 3 },
  { blocSlug: "wotc", name: "Gym Heroes", abbreviation: "WOTC-GH", slug: "gym-heroes", releaseDate: new Date("2000-08-14"), order: 4 },
  { blocSlug: "wotc", name: "Team Rocket", abbreviation: "WOTC-TR", slug: "team-rocket", releaseDate: new Date("2000-04-24"), order: 5 },
  { blocSlug: "wotc", name: "Set de base 2", abbreviation: "WOTC-B2", slug: "set-de-base-2", releaseDate: new Date("2000-02-24"), order: 6 },
