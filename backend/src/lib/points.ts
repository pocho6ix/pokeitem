...
import { QUEST_MAP, REFERRAL_POINTS } from "./quests";
import { getPriceForVersion } from "./display-price";
...
// ─── Award points for a referral (idempotent) ────────────────────────────────
...
// ─── Complete a quest (throws if inactive or already done) ───────────────────
...
// ─── Idempotent quest completion (no throw) ──────────────────────────────────
...
// ─── Check & update progressive quests ───────────────────────────────────────
